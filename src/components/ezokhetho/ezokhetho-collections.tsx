...
const collections: CollectionCard[] = [
  {
    ...
    imageAlt: 'Mapetla EXT collection by Ezokhetho',
    accent: '#FF6B00',
  ...
  },
  {
    ...
    subtitle: 'SAMW-TWF',
    description: (optimizedMappings as any).collections.entathakusa?.desc || 'Celebrating the morning dawn, new beginnings, and the progression of contemporary South African design.',
    image: "/images/cover/Entathakusa '26.jpg",
    imageAlt: 'Entathakusa collection by Ezokhetho',
    accent: '#0033A0',
  },
  {
    id: 'zodwa',
